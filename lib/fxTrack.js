...
import { REVERB_IR_PRESETS, FX_BUSES, FX_SYNC_DIVISIONS, FX_SYNC_TARGETS, FX_PARAM_SPECS, normalizeIrType } from './fxSpecs.js'
...
export class FxTrack {
  constructor(busId, outputNode, overrides = {}) {
    ...
    if (busId === 'reverb') {
      this._irType         = normalizeIrType(defs.irType ?? 'synthetic')
