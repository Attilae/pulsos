...
function normalizeAutomationCfg(automationCfg, trackSynthTypes = {}, activeFxTracks = []) {
  const out = {}
...
export function applySnapshot(snapshot, setters, engine, routes) {
  ...
  const automationCfg = normalizeAutomationCfg(s.automationCfg, s.trackSynthTypes, s.activeFxTracks)
