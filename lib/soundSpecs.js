...
// The six instruments the DAW's lane picker offers (DawView/engine re-export this
// as SYNTH_TYPES). SYNTH_DEFAULTS has six more that plans may still choose, but a
// lane set to one of those can't be reselected from the picker — the AI composer
// is steered to these.
