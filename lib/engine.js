...
export class TransitEngine {
  ...
  removeRoute(routeId) {
    ...
    for (const m of [this._pitchOffsets, this._pitchVariety, this._stopVelocities, this._noteChances, this._stopChances, this._loopPatterns, this._partLoopTicks, this._partStartTicks, this._octaveShifts, this._semitoneShifts, this._glides, this._legatoRoutes,
  ...
  _buildRoutePart(route) {
    ...
    const part = new Tone.Part((time, stop) => {
      ...
      if (this._arpeggiators[route.id]?.enabled) {
        ...
        this._triggerSynth(e, note, noteDur, time, velocity)
      }
