...
import { PICKER_SYNTH_TYPES } from '../soundSpecs.js'
...
- Prefer the six instruments the DAW's picker offers: ${PICKER_SYNTH_TYPES.join(', ')}. The other accepted types play, but the user cannot reselect them and several ignore parts of the plan.
- Fit each envelope to the one-beat gate (60 ÷ bpm s) and to the rhythmic spacing. Envelope families for ADSR synths (seconds, attack/decay/sustain/release): compact bass pulse 0.005–0.015 / 0.08–0.18 / 0 / 0.05–0.12; plucked foreground 0.003–0.01 / 0.1–0.25 / 0 / 0.06–0.2; held lead 0.01–0.04 / 0.1–0.3 / 0.4–0.7 / 0.1–0.3; soft support 0.03–0.1 / 0.15–0.5 / 0.3–0.65 / 0.3–0.8; slow swell (attack 0.3–1) only on held notes (drone, legato mono voice) or when one beat is longer than the attack. Sampler and Drums take attack and release only; PluckSynth takes none of it.
...
- Tone: the waveform is the spectrum the filter works on — triangle soft, square hollow and present (a bass that survives small speakers), sawtooth bright, fat* wide and detuned. A lowpass cannot add missing harmonics, and a cutoff below the bass fundamental weakens the note; keep Q moderate so the resonance is not a second hook. FM: harmonicity 1 or 2 stays harmonic, odd fractions turn clangorous; modulationIndex 2–5 is plenty of brightness; a mod envelope that decays faster than the carrier gives a struck, bright onset with a cleaner tail.
- Granular is a quiet, related shadow of a synth-sourced support lane (mix around 0.08), never on the bass.
