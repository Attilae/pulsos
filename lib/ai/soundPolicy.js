...
- Build most beats from the instruments whose shape a plan fully controls: Synth, FMSynth, PolySynth, NoiseSynth, Sampler and Drums. Reach for the others for a specific colour, knowing their limits (see INSTRUMENTS).
