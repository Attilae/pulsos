...
- pitchVariety.contour: ${PITCH_CONTOURS.join(', ')}; pitchVariety.variety: 0..1. Geographic maps latitude; demand maps stop usage/service to pitch. At 0 either contour is pure.
