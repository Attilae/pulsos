        ...
        tracks: {
          ...
          items: {
            ...
            properties: {
              ...
              noteChance: { type: ['number', 'null'] },
              loopPattern: {
                type: ['object', 'null'], additionalProperties: false,
                properties: { play: { type: 'integer' }, rest: { type: 'integer' }, offset: { type: 'integer' } },
                required: ['play', 'rest', 'offset'],
              },
              label: {
                type: ['string', 'null'],
            ...
            required: [
              ...
              'gridResolution', 'pitchVariety', 'noteChance', 'loopPattern', 'label', 'sidechain',
            ],
          },
        },
        drums: {
